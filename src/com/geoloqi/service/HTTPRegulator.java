...
class HTTPRegulator {
	...
	private void update(boolean b) {
		...
		String debug = "Window size is now " + windowSize + " points.  " + (slowStart ? "Slow start is on.  " : "Slow start is off.  ") + (congestionAvoidance ? "Congestion avoidance is on." : "Congestion avoidance is off.");
		Util.log(debug);
	}
